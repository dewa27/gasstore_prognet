                        ...
                        <table class="table table-striped">
                            {{-- <form action="/admin/products/search" id="searchForm">
                                <div class="p-1 bg-light rounded-pill shadow-sm mb-4">
                                    <div class="input-group">
                                        ...
                                        <input id="search" type="search" placeholder="Cari nama produk..."
                            ...
                            <tbody id="displayData">
                                ...
                                <tr>
                                    ...
                                    <td>{{$product->stock}}</td>
                                    <td>
                                        <a href="/admin/products/trashed/{{$product->id}}/restore"
...
<script>
    $(function(){
        ...
        $('.del-button').click(function(){
            $('#delForm').attr('action',`/admin/products/trashed/${$(this).attr('id')}/delete`);
        });
        var base_path = "{{url('/')}}";
        let result;
