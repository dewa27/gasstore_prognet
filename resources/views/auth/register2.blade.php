				...
				<div class="col-md-8">
					<form method="POST" action="{{ route('register') }}">
						...
						<div class="form-group">
							...
							<input type="text"
								class="fonted bg-transparent text-white form-control form-control-underlined py-0 @error('name') is-invalid @enderror"
								name="name" autocomplete="off" placeholder="Masukkan nama Anda">
							@error('name')
